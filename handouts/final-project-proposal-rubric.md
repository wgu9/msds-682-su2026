...
| **2. Data Source and Classification** | **2.1 Planned data source:** Identifies the source, official URL, owner, access method, material limitations, and a credible local sample or replay fallback. | 1 |
